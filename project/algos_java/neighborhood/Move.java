...
/**
 * This abstract class represents a Move (or Neighborhood). The basic methods as
 * well as several counters (for future
...
public abstract class Move {
     ...
     * @param priority the priority (priority) of this neighborhood structure. The
    ...
    /**
     * This method must be called whenever the modification made by this move is
     * accepted. It ensures that the solution
    ...
    /**
     * This method returns does the move and returns the impact (delta cost) in the
     * solution.
     *
    ...
    public double doMove(Solution solution) {
        ...
        initialCost = solution.getObj();
        return deltaObj = Integer.MAX_VALUE;
    }

    public int getDeltaObj() {
        return deltaObj;
    }

    /**
     * This method returns a boolean indicating whether this neighborhood can be
     * applied to the current solution.
     *
     * @return true if this neighborhood can be applied to the current solution and
     *         false otherwise.
     */
    ...
    /**
     * This method must be called whenever the modification made by this move are
     * rejected. It ensures that the solution
     * as well as other structures are updated accordingly.
     */
    public void reject() {
    ...
    /**
     * This method is called whenever the neighborhood should be reset (mainly to
     * avoid the need of creating another
     * object).
     */
    public void reset() {
    }
